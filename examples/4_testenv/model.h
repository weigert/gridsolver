...
void Interface::drawModel<Example>(View &view, Example &example){
  ...
  ImGui::DragInt("Time Steps", &timeSteps, 1, 1, 500, "%i");
	...
	/*
		...
		You need to perform a pushID and popID for every one of these blocks,
		because the buttons are names the same. You could also just rename them
		so they have unique IDs.
	*/
